...
/*   Updated: 2025/11/04 07:12:55 by gustaoli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_game *game)
{
	...
	textures.item_icon = mlx_load_png("./textures/gomu-icon.png");
...
void	unload_textures(t_texture textures)
{
	...
	mlx_delete_texture(textures.item_icon);
